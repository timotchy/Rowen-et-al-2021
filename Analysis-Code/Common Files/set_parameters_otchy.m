...
par.min_clus = 10;                   % minimun size of a cluster
...
par.fname_in = 'tmp_data'; % temp filename for interaction with SPC

% DETECTION PARAMETERS
par.sr = 44150;                        % sampling rate (in Hz).
par.tmax = 'all';                      % maximum time to load
par.w_pre = 44;                        % number of pre-event data points stored (default 20)
par.w_post = 44;                       % number of post-event data points stored (default 44))
ref = 0.8;                             % detector dead time (in ms)
par.ref = floor(ref *par.sr/1000);     % conversion to datapoints
par.stdmin = 5;                      % minimum threshold for detection
par.stdmax = 200;                       % maximum threshold for detection
